...
func (c *ChenSongClient) Request(method string, RequestBody interface{}) (*SnowLumaResponse, error) {
...
func (c *ChenSongClient) SendGroupMessage(msg string) (*SnowLumaResponse, error) {
	res, err := c.Request("POST", SnowLumaSendGroupMessage{
